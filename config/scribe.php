...
return [
    ...
    'description' => 'ShopHub API - E-commerce backend API for Angular frontend',
    ...
    'auth' => [
        ...
        'default' => false, // Public routes don't require auth, protected routes do
        ...
        'extra_info' => 'You can retrieve your token by logging in via <code>POST /auth/login</code> endpoint. Include the token in the Authorization header as: <code>Bearer {token}</code>.',
    ],
